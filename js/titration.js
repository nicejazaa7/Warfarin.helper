...
// allowNoChange: grace zones just outside target where "continue same dose"
// is offered as one option alongside the adjustment suggestions.
const TITRATION = [
  { max: 1.49,     type: 'adjust',      pct: [+10, +20], label: 'Increase dose 10–20%' },
  { max: 1.84,     type: 'adjust',      pct: [+5,  +10], label: 'Increase dose 5–10%' },
  { max: 1.99,     type: 'adjust',      pct: [+5,  +10], allowNoChange: true, label: 'Increase dose 5–10%' },
  { max: 3.0,      type: 'adjust',      pct: [0,     0], label: 'Continue same dose' },
  { max: 3.15,     type: 'adjust',      pct: [-5,  -10], allowNoChange: true, label: 'Decrease dose 5–10%' },
